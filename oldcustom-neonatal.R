...
if(all(!is.na(discharge_wt_units), as.numeric(discharge_wt_units) %in% c(1,2), as.Date(date_today)>=as.Date("2018-10-15"),
       ((discharge_wt_units == 1 & (as.numeric(discharge_weight)<1800 | as.numeric(discharge_weight)>6500)) |
        (discharge_wt_units == 2 & (as.numeric(discharge_weight)<1.8 | as.numeric(discharge_weight)>6.5))))){
  form__x2014cin = c(form__x2014cin, "Discharge Information")
