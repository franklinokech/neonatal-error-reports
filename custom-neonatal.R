    ...
    if (isTRUE(is_int(hosp_to_validate))) {
      ...
      if (!isTRUE(data_missing(hosp_id))) {
        if (!isTRUE(hosp_id %in% hosp_to_validate)) {
          ...
          logic_x2014cin = c(logic_x2014cin,NA_character_)
        }
      }
...
if (isTRUE(date_can_be_validated(date_adm) && date_can_be_validated(date_of_birth) && date_can_be_validated(date_discharge))) {
  if (as.Date(date_of_birth, "%Y-%m-%d") > as.Date(date_adm, "%Y-%m-%d") || as.Date(date_of_birth, "%Y-%m-%d") > as.Date(date_discharge, "%Y-%m-%d") || as.Date(date_of_birth, "%Y-%m-%d") >= Sys.Date() || as.Date(date_of_birth, "%Y-%m-%d") > as.Date(date_today, "%Y-%m-%d")) {
    form__x2014cin = c(form__x2014cin, "Biodata")
    name__x2014cin = c(name__x2014cin, "date_of_birth")
    msg__x2014cin = c(msg__x2014cin, "'Date of birth' cannot be after 'Date of Admission'")
    sect__x2014cin = c(sect__x2014cin, "")
    type__x2014cin = c(type__x2014cin, "")
    entry__x2014cin = c(entry__x2014cin, date_of_birth)
    logic_x2014cin = c(logic_x2014cin,NA_character_)
  }
}

if (isTRUE(date_can_be_validated(date_adm) && date_can_be_validated(date_of_birth) && date_can_be_validated(date_discharge))) {
  if (as.Date(date_adm, "%Y-%m-%d") < as.Date(date_of_birth, "%Y-%m-%d") || as.Date(date_adm, "%Y-%m-%d") >= Sys.Date() || as.Date(date_adm, "%Y-%m-%d") > as.Date(date_today, "%Y-%m-%d")) {
    form__x2014cin = c(form__x2014cin, "Biodata")
    name__x2014cin = c(name__x2014cin, "date_adm")
    msg__x2014cin = c(msg__x2014cin, "'Admission Date' cannot be before 'Date of Birth' or after 'Date of entry'")
    sect__x2014cin = c(sect__x2014cin, "")
    type__x2014cin = c(type__x2014cin, "")
    entry__x2014cin = c(entry__x2014cin, date_adm)
    logic_x2014cin = c(logic_x2014cin,NA_character_)
...
if (isTRUE(date_can_be_validated(date_adm) && date_can_be_validated(date_of_birth) && date_can_be_validated(date_discharge))) {
  if (as.Date(date_discharge, "%Y-%m-%d") < as.Date(date_of_birth, "%Y-%m-%d") || as.Date(date_discharge, "%Y-%m-%d") < as.Date(date_adm, "%Y-%m-%d") || as.Date(date_discharge, "%Y-%m-%d") >= Sys.Date() || as.Date(date_discharge, "%Y-%m-%d") > as.Date(date_today, "%Y-%m-%d")) {
    form__x2014cin = c(form__x2014cin, "Biodata")
    name__x2014cin = c(name__x2014cin, "date_discharge")
    msg__x2014cin = c(msg__x2014cin, "'Discharge Date' cannot be after 'Date of Entry' or before 'date of admission'/ 'date of birth'")
    sect__x2014cin = c(sect__x2014cin, "")
    type__x2014cin = c(type__x2014cin, "")
...
#   if (isTRUE(as.Date(date_adm) > as.Date(date_today))) {
#     form__x2014cin = c(form__x2014cin, "Biodata")
#     name__x2014cin = c(name__x2014cin, "date_adm")
...
.__update_date = c(
  ...
  Reduce(c, lapply(.__update, function(x) x$get_update_date("other_weight", hosp_id))),
...
if (isTRUE(!data_missing(weight_doc) & as.numeric(weight_doc)==1)) {
  ...
  #   msg__x2014cin = c(msg__x2014cin, paste("Invalid date_1 value!"))
  #   sect__x2014cin = c(sect__x2014cin, "weight_monitoring")
  #   type__x2014cin = c(type__x2014cin, "")
...
sapply(paste0('other_weight_', c(2:20)), function(x){
  ...
  #       msg__x2014cin = c(msg__x2014cin, paste("Invalid",d,"value!"))
  #       sect__x2014cin = c(sect__x2014cin, "weight_monitoring")
  #       type__x2014cin = c(type__x2014cin, "")
...
if (all(!is.na(wt_now) , abs(as.numeric(wt_now))!=1 , !(as.numeric(wt_now)>0.5 & as.numeric(wt_now)<6),
  ...
  msg__x2014cin = c(msg__x2014cin, paste("Value for weight now is out of range!"))
...
if (all(as.numeric(birth_wt)>0.5,!is.na(as.numeric(birth_wt)), as.Date(date_today)>=as.Date("2018-10-15"))){
  if (isTRUE(is.na(birth_wt_units))) {
    ...
    msg__x2014cin = c(msg__x2014cin, paste("Units for birth weight is missing'!"))
    sect__x2014cin = c(sect__x2014cin, "")
    type__x2014cin = c(type__x2014cin, "")
    ...
    if (any(
      ...
      msg__x2014cin = c(msg__x2014cin, paste("'Birth weight' is out of range!"))
      sect__x2014cin = c(sect__x2014cin, "")
      type__x2014cin = c(type__x2014cin, "")
...
if(all(!is.na(discharge_wt_units), as.numeric(discharge_wt_units) %in% c(1,2), as.Date(date_today)>=as.Date("2018-10-15"), as.numeric(outcome) != 2,
       (birth_wt_units == 1 & !is.na(birth_wt) & abs(as.numeric(birth_wt)) > 0 & as.numeric(birth_wt)<1500),
       (birth_wt_units == 2 & !is.na(birth_wt) & abs(as.numeric(birth_wt)) > 0 & as.numeric(birth_wt)<1.5),
       (discharge_wt_units == 1 & !is.na(discharge_weight) & (abs(as.numeric(discharge_weight))<1700 | abs(as.numeric(discharge_weight))>6500)),
       (discharge_wt_units == 2 & !is.na(discharge_weight) & (abs(as.numeric(discharge_weight))<1.7 | abs(as.numeric(discharge_weight))>6.5))
)){
  form__x2014cin = c(form__x2014cin, "Discharge Information")
  name__x2014cin = c(name__x2014cin, "discharge_weight")
...
if(!is.na(t_birth) &
   stringr::str_trim(t_birth)!=-1 &
   stringr::str_trim(t_birth)!="" &
   !timeIsValid(t_birth) ){
  form__x2014cin = c(form__x2014cin, "Biodata")
...
if(!is.na(t_adm) & stringr::str_trim(t_adm)!=-1 & stringr::str_trim(t_adm)!="" &  !timeIsValid(t_adm) ){
  form__x2014cin = c(form__x2014cin, "Biodata")
...
if(!is.na(t_seen) &
   stringr::str_trim(t_seen)!=-1 &
   stringr::str_trim(t_seen)!="" &
   !timeIsValid(t_seen) ){
  form__x2014cin = c(form__x2014cin, "Biodata")
  name__x2014cin = c(name__x2014cin, "t_seen")
  msg__x2014cin = c (msg__x2014cin, "Time Baby seen if invalid!")
  sect__x2014cin = c(sect__x2014cin, "")
  type__x2014cin = c(type__x2014cin, "")
...
if(cpap==1 &
   !is.na(cpap_start_time) &
   stringr::str_trim(cpap_start_time)!=-1 &
   stringr::str_trim(cpap_start_time)!="" &
   !timeIsValid(cpap_start_time)
){
  form__x2014cin = c(form__x2014cin, "Support care")
...
if(cpap==1 &
   !is.na(cpap_end_time) &
   stringr::str_trim(cpap_end_time)!=-1 &
   stringr::str_trim(cpap_end_time)!="" &
   !timeIsValid(cpap_end_time)
...
if(
  !is.na(t_discharge) &
  stringr::str_trim(t_discharge)!=-1 &
  stringr::str_trim(t_discharge)!="" &
  !timeIsValid(t_discharge)
){
  form__x2014cin = c(form__x2014cin, "Biodata")
...
if(
  ...
  (!is.na(total_volume_of_iv_fluids) &
   as.numeric(total_volume_of_iv_fluids) >0) & (!is.na(duration_of_iv_fluid_presc) & as.numeric(duration_of_iv_fluid_presc) >0) &
  !(round(as.numeric(24/as.numeric(duration_of_iv_fluid_presc)*total_volume_of_iv_fluids)) %in% c(40:300))){
  form__x2014cin = c(form__x2014cin, "supportive_care")
  name__x2014cin = c(name__x2014cin, "total_volume_of_iv_fluids")
  msg__x2014cin = c(msg__x2014cin, "'Fluid prescription Volume' out of range tot")
  sect__x2014cin = c(sect__x2014cin, "")
  type__x2014cin = c(type__x2014cin, "")
  entry__x2014cin = c(entry__x2014cin, total_volume_of_iv_fluids)
  logic_x2014cin = c(logic_x2014cin,NA_character_)
}

if(

  (!is.na(total_vol_of_other_fluid) &
   as.numeric(total_vol_of_other_fluid) >0) & (!is.na(duration_prescribed) & as.numeric(duration_prescribed) >0) &
  !(round(as.numeric(24/duration_prescribed*total_vol_of_other_fluid)) %in% c(40:300))){
  form__x2014cin = c(form__x2014cin, "supportive_care")
  name__x2014cin = c(name__x2014cin, "total_vol_of_other_fluid")
  msg__x2014cin = c(msg__x2014cin, "'Fluid prescription Volume' out of range tot")
  sect__x2014cin = c(sect__x2014cin, "")
  type__x2014cin = c(type__x2014cin, "")
  entry__x2014cin = c(entry__x2014cin, total_vol_of_other_fluid)
  logic_x2014cin = c(logic_x2014cin,NA_character_)
}
...
# Add the following to the custom script in the error validation folder
if (all(as.numeric(postdischarge_weight_1)>0.5, !is.na(as.numeric(postdischarge_weight_1)), as.Date(date_today)>=as.Date("2020-03-07"))){
if (isTRUE(!is.na(postdischarge_weight_1) & is.na(post_weight_unit1))) {
...
if (all(as.numeric(postdischarge_weight_2)>0.5, !is.na(as.numeric(postdischarge_weight_2)), as.Date(date_today)>=as.Date("2020-03-07"))){
  if (isTRUE(!is.na(postdischarge_weight_2) & is.na(post_weight_unit2))) {
    form__x2014cin = c(form__x2014cin, "Post Discharge Weight monitoring")
...
if (all(as.numeric(postdischarge_weight_3)>0.5, !is.na(as.numeric(postdischarge_weight_3)), as.Date(date_today)>=as.Date("2020-03-07"))){
if (isTRUE(!is.na(postdischarge_weight_3) & is.na(post_weight_unit3))) {
  form__x2014cin = c(form__x2014cin, "Post Discharge Weight monitoring")
...
if (all(as.numeric(postdischarge_weight_4)>0.5, !is.na(as.numeric(postdischarge_weight_4)), as.Date(date_today)>=as.Date("2020-03-07"))){
if (isTRUE(!is.na(postdischarge_weight_4) & is.na(post_weight_unit4))) {
  form__x2014cin = c(form__x2014cin, "Post Discharge Weight monitoring")
...
if (all(as.numeric(postdischarge_weight_5)>0.5, !is.na(as.numeric(postdischarge_weight_5)), as.Date(date_today)>=as.Date("2020-03-07"))){
if (isTRUE(!is.na(postdischarge_weight_5) & is.na(post_weight_unit5))) {
  form__x2014cin = c(form__x2014cin, "Post Discharge Weight monitoring")
...
if (all(as.numeric(postdischarge_weight_6)>0.5, !is.na(as.numeric(postdischarge_weight_6)), as.Date(date_today)>=as.Date("2020-03-07"))){
if (isTRUE(!is.na(postdischarge_weight_6) & is.na(post_weight_unit6))) {
  form__x2014cin = c(form__x2014cin, "Post Discharge Weight monitoring")
...
if (isTRUE(all(!as.Date(post_weight_date1, "%Y-%m-%d") %in% as.Date("1914-01-01","1913-01-01"),
               !as.Date(post_weight_date1, "%Y-%m-%d")>=as.Date(date_adm), !as.Date(post_weight_date1, "%Y-%m-%d")<=(date_today), post_weight_date1 !='', !is.na(post_weight_date1)))){
  form__x2014cin = c(form__x2014cin, "post_discharge_weights")
...
if (isTRUE(all(!as.Date(post_weight_date2, "%Y-%m-%d") %in% as.Date("1914-01-01","1913-01-01"),
               !as.Date(post_weight_date2, "%Y-%m-%d")>=as.Date(date_adm), !as.Date(post_weight_date2, "%Y-%m-%d")<=(date_today), post_weight_date2 !='', !is.na(post_weight_date2)))){
  form__x2014cin = c(form__x2014cin, "post_discharge_weights")
...
if (isTRUE(all(!as.Date(post_weight_date3, "%Y-%m-%d") %in% as.Date("1914-01-01","1913-01-01"),
               !as.Date(post_weight_date3, "%Y-%m-%d")>=as.Date(date_adm), !as.Date(post_weight_date3, "%Y-%m-%d")<=(date_today), post_weight_date3 !='', !is.na(post_weight_date3)))){
  form__x2014cin = c(form__x2014cin, "post_discharge_weights")
...
if (isTRUE(all(!as.Date(post_weight_date4, "%Y-%m-%d") %in% as.Date("1914-01-01","1913-01-01"),
               !as.Date(post_weight_date4, "%Y-%m-%d")>=as.Date(date_adm), !as.Date(post_weight_date4, "%Y-%m-%d")<=(date_today), post_weight_date4 !='', !is.na(post_weight_date4) ))){
  form__x2014cin = c(form__x2014cin, "post_discharge_weights")
...
if (isTRUE(all(!as.Date(post_weight_date5, "%Y-%m-%d") %in% as.Date("1914-01-01","1913-01-01"),
               !as.Date(post_weight_date5, "%Y-%m-%d")>=as.Date(date_adm), !as.Date(post_weight_date5, "%Y-%m-%d")<=(date_today), post_weight_date5 !='', !is.na(post_weight_date5) ))){
  form__x2014cin = c(form__x2014cin, "post_discharge_weights")
...
if (isTRUE(all(!as.Date(post_weight_date6, "%Y-%m-%d") %in% as.Date("1914-01-01","1913-01-01"),
               !as.Date(post_weight_date6, "%Y-%m-%d")>=as.Date(date_adm), !as.Date(post_weight_date6, "%Y-%m-%d")<=(date_today), post_weight_date6 !='', !is.na(post_weight_date6) ))){
  form__x2014cin = c(form__x2014cin, "post_discharge_weights")
