...
if(all(!is.na(discharge_wt_units), as.numeric(discharge_wt_units) %in% c(1,2), as.Date(date_today)>=as.Date("2018-10-15"),outcome ==1,
       ((discharge_wt_units == 1 & (as.numeric(discharge_weight)<1750 | as.numeric(discharge_weight)>6500)) |
        (discharge_wt_units == 2 & (as.numeric(discharge_weight)<1.75 | as.numeric(discharge_weight)>6.5))))){
  form__x2014cin = c(form__x2014cin, "Discharge Information")
  name__x2014cin = c(name__x2014cin, "discharge_weight")
  msg__x2014cin = c(msg__x2014cin, paste0("Discharge weight(",discharge_wt_units,") is out of range'!"))
  sect__x2014cin = c(sect__x2014cin, "")
  type__x2014cin = c(type__x2014cin, "")
...
# returning within range values
if (isTRUE(!is.na(postdischarge_weight_1) & postdischarge_weight_1 >0 &
           
           (
             (as.numeric(postdischarge_weight_1)<1000 & as.numeric(postdischarge_weight_1)<1.8 | as.numeric(postdischarge_weight_1)<1000 & as.numeric(postdischarge_weight_1)>6.5) |
             (as.numeric(postdischarge_weight_1)> 1000 & as.numeric(postdischarge_weight_1)<1800 |as.numeric(postdischarge_weight_1)>1000 & as.numeric(postdischarge_weight_1)>6500)
           )
  ...
  sect__x2014cin = c(sect__x2014cin, "postdischarge_weight_1")
  type__x2014cin = c(type__x2014cin, "")
...
if (isTRUE(!is.na(postdischarge_weight_2) & postdischarge_weight_2 >0 &
           
           (
             (as.numeric(postdischarge_weight_2)<1000 & as.numeric(postdischarge_weight_2)<1.8 | as.numeric(postdischarge_weight_2)<1000 & as.numeric(postdischarge_weight_2)>6.5) |
             (as.numeric(postdischarge_weight_2)> 1000 & as.numeric(postdischarge_weight_2)<1800 |as.numeric(postdischarge_weight_2)>1000 & as.numeric(postdischarge_weight_2)>6500)
           )
  ...
  msg__x2014cin = c(msg__x2014cin, "Post discharge weight out of range!")
  sect__x2014cin = c(sect__x2014cin, "postdischarge_weight_2")
  type__x2014cin = c(type__x2014cin, "")
  entry__x2014cin = c(entry__x2014cin, postdischarge_weight_2)
  logic_x2014cin = c(logic_x2014cin,NA_character_)
}

if (isTRUE(!is.na(postdischarge_weight_3) & postdischarge_weight_3 >0 &
           
           (
             (as.numeric(postdischarge_weight_3)<1000 & as.numeric(postdischarge_weight_3)<1.8 | as.numeric(postdischarge_weight_3)<1000 & as.numeric(postdischarge_weight_3)>6.5) |
             (as.numeric(postdischarge_weight_3)> 1000 & as.numeric(postdischarge_weight_3)<1800 |as.numeric(postdischarge_weight_3)>1000 & as.numeric(postdischarge_weight_3)>6500)
           )
  ...
  msg__x2014cin = c(msg__x2014cin, "Post discharge weight out of range!")
  sect__x2014cin = c(sect__x2014cin, "postdischarge_weight_3")
  type__x2014cin = c(type__x2014cin, "")
  entry__x2014cin = c(entry__x2014cin, postdischarge_weight_3)
  logic_x2014cin = c(logic_x2014cin,NA_character_)
}

if (isTRUE(!is.na(postdischarge_weight_4) & postdischarge_weight_4 >0 &
           
           (
             (as.numeric(postdischarge_weight_4)<1000 & as.numeric(postdischarge_weight_4)<1.8 | as.numeric(postdischarge_weight_4)<1000 & as.numeric(postdischarge_weight_4)>6.5) |
             (as.numeric(postdischarge_weight_4)> 1000 & as.numeric(postdischarge_weight_4)<1800 |as.numeric(postdischarge_weight_4)>1000 & as.numeric(postdischarge_weight_4)>6500)
           )
  ...
  msg__x2014cin = c(msg__x2014cin, "Post discharge weight out of range!")
  sect__x2014cin = c(sect__x2014cin, "postdischarge_weight_4")
  type__x2014cin = c(type__x2014cin, "")
  entry__x2014cin = c(entry__x2014cin, postdischarge_weight_4)
  logic_x2014cin = c(logic_x2014cin,NA_character_)
}

if (isTRUE(!is.na(postdischarge_weight_5) & postdischarge_weight_5 >0 &
           
           (
             (as.numeric(postdischarge_weight_5)<1000 & as.numeric(postdischarge_weight_5)<1.8 | as.numeric(postdischarge_weight_5)<1000 & as.numeric(postdischarge_weight_5)>6.5) |
             (as.numeric(postdischarge_weight_5)> 1000 & as.numeric(postdischarge_weight_5)<1800 |as.numeric(postdischarge_weight_5)>1000 & as.numeric(postdischarge_weight_5)>6500)
           )
  ...
  msg__x2014cin = c(msg__x2014cin, "Post discharge weight out of range!")
  sect__x2014cin = c(sect__x2014cin, "postdischarge_weight_5")
  type__x2014cin = c(type__x2014cin, "")
  entry__x2014cin = c(entry__x2014cin, postdischarge_weight_5)
  logic_x2014cin = c(logic_x2014cin,NA_character_)
}

if (isTRUE(!is.na(postdischarge_weight_6) & postdischarge_weight_6 >0 &
           
           (
             (as.numeric(postdischarge_weight_6)<1000 & as.numeric(postdischarge_weight_6)<1.8 | as.numeric(postdischarge_weight_6)<1000 & as.numeric(postdischarge_weight_6)>6.5) |
             (as.numeric(postdischarge_weight_6)> 1000 & as.numeric(postdischarge_weight_6)<1800 |as.numeric(postdischarge_weight_6)>1000 & as.numeric(postdischarge_weight_6)>6500)
           )
)){
  form__x2014cin = c(form__x2014cin, "post_discharge_weights")
  name__x2014cin = c(name__x2014cin, "postdischarge_weight_6")
  msg__x2014cin = c(msg__x2014cin, "Post discharge weight out of range!")
  sect__x2014cin = c(sect__x2014cin, "postdischarge_weight_6")
  type__x2014cin = c(type__x2014cin, "")
